...
module.exports = (app, apicache) => { // console.log(Object.keys(PutInstanceHere.__proto__)); => magic logger!
    ...
    */
    ...
    app.patch('/v1/ubah-pw', rateSlowdown, rateLimiter, AuthControl.jwtauthAll, Validator.ubahPwCheck, AlluserControl.ubahPass); // dengan auth
    app.post('/v1/avatar', rateSlowdown, rateLimiter, AuthControl.jwtauthAll, uploadPic.single('foto_profil'), AlluserControl.setAvatar);// tambah baru, atau rubah   
    app.get('/v1/profil', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getProfilUser);// profil singkat u/ disidebar
    app.get('/v1/kelas', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getAllKelas);
    app.get('/v1/kelas/search', rateLimiter, AuthControl.jwtauthAll, AlluserControl.searchKelas);
    app.get('/v1/kelas/:id_kelas', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getKelas);
    app.get('/v1/kelas/:id_semester', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getperSemester);    
    app.get('/v1/paket-soal/:id_paket/soal-essay', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getSoalPaket); //get all soal untuk paket tertentu
    app.get('/v1/profil-dosen/:id_dosen', rateLimiter, AuthControl.jwtauthAll, DosenControl.getProfile);
    app.get('/v1/profil-mahasiswa/:id_mhs', rateLimiter, AuthControl.jwtauthAll, MhsControl.getProfile);
    app.get('/v1/pengumuman', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getPengumumn);
    app.get('/v1/notifikasi', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getNotifikasi);
    app.get('/v1/jenis-ujian', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getJenisUjian);
    app.get('/v1/kelompok-matakuliah', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getKelompokMatakuliah);
    app.get('/v1/peminatan', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getPeminatan);
    app.get('/v1/semester', rateLimiter, AuthControl.jwtauthAll, AlluserControl.getSemester);
    ...
    app.get('/v1/ujian/:id_ujian/tipe-penilaian', rateLimiter, AlluserControl.getTipePenilaian);
    app.post('/v1/notifikasi', rateSlowdown, rateLimiter, AlluserControl.setNotifikasi);
    app.post('/v1/nilai/:id_ujian', rateSlowdown, rateLimiter, AlluserControl.setNilaiAuto); //berlaku kepada seluruh peserta ujian

    /*--RUTE SUPER ADMIN--*/
    app.get('/v1/client', rateLimiter, AuthControl.getAllClient);
    app.post('/v1/client', rateSlowdown, rateLimiter, AuthControl.setClient);
    app.put('/v1/client/:id_client', rateSlowdown, rateLimiter, AuthControl.putClient);
    app.patch('/v1/client/:id_client/api-key', rateSlowdown, rateLimiter, AuthControl.patchClientKey);
    app.delete('/v1/client/:id_client', rateSlowdown, rateLimiter, AuthControl.deleteClient);
